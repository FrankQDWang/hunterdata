...
Input JSONL:
`data/runs/20260522-113750/agents/batches/agent-069.jsonl`

Output JSONL:
`data/runs/20260522-113750/agents/results/agent-069-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-113750/raw/agents/agent-069/`
