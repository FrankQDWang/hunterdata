...
Input JSONL:
`data/runs/20260522-113750/agents/batches/agent-050.jsonl`

Output JSONL:
`data/runs/20260522-113750/agents/results/agent-050-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-113750/raw/agents/agent-050/`
