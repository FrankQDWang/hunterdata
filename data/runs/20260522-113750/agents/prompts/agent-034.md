...
Input JSONL:
`data/runs/20260522-113750/agents/batches/agent-034.jsonl`

Output JSONL:
`data/runs/20260522-113750/agents/results/agent-034-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-113750/raw/agents/agent-034/`
