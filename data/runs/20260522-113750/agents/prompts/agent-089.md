...
Input JSONL:
`data/runs/20260522-113750/agents/batches/agent-089.jsonl`

Output JSONL:
`data/runs/20260522-113750/agents/results/agent-089-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-113750/raw/agents/agent-089/`
