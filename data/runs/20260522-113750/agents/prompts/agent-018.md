...
Input JSONL:
`data/runs/20260522-113750/agents/batches/agent-018.jsonl`

Output JSONL:
`data/runs/20260522-113750/agents/results/agent-018-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-113750/raw/agents/agent-018/`
