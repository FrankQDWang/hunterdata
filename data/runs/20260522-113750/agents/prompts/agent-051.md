...
Input JSONL:
`data/runs/20260522-113750/agents/batches/agent-051.jsonl`

Output JSONL:
`data/runs/20260522-113750/agents/results/agent-051-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-113750/raw/agents/agent-051/`
