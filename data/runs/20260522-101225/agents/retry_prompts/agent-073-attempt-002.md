...
Previous validation failure: does not prove same company in raw evidence
...
Input JSONL:
`data/runs/20260522-101225/agents/batches/agent-073.jsonl`

Output JSONL:
`data/runs/20260522-101225/agents/results/agent-073-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-101225/raw/agents/agent-073/`
