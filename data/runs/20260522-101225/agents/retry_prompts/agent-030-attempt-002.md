...
Previous validation failure: agent result for company-36e5f022 does not prove same company in raw evidence
...
Input JSONL:
`data/runs/20260522-101225/agents/batches/agent-030.jsonl`

Output JSONL:
`data/runs/20260522-101225/agents/results/agent-030-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-101225/raw/agents/agent-030/`
