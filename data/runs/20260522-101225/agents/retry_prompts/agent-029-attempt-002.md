...
Previous validation failure: agent result for company-ff8b1207 does not prove same company in raw evidence: expected company name, phone, license number, or known company domain
...
Input JSONL:
`data/runs/20260522-101225/agents/batches/agent-029.jsonl`

Output JSONL:
`data/runs/20260522-101225/agents/results/agent-029-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-101225/raw/agents/agent-029/`
