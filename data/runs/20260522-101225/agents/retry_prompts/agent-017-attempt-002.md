...
Previous validation failure: agent result for company-7106e213 does not prove same company in raw evidence: expected company name, phone, license number, or known company domain
...
Input JSONL:
`data/runs/20260522-101225/agents/batches/agent-017.jsonl`

Output JSONL:
`data/runs/20260522-101225/agents/results/agent-017-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-101225/raw/agents/agent-017/`
