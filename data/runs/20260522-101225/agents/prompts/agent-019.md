...
Input JSONL:
`data/runs/20260522-101225/agents/batches/agent-019.jsonl`

Output JSONL:
`data/runs/20260522-101225/agents/results/agent-019-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-101225/raw/agents/agent-019/`
