...
Input JSONL:
`data/runs/20260522-101225/agents/batches/agent-039.jsonl`

Output JSONL:
`data/runs/20260522-101225/agents/results/agent-039-results.jsonl`

Raw Dokobot evidence directory:
`data/runs/20260522-101225/raw/agents/agent-039/`
